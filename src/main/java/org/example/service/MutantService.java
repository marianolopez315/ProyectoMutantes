...
public class MutantService {
    ...
    public boolean analyzeDna(String[] dna) {
        //Calcular el Hash del ADN
        String dnaHash = calculateHash(dna);

        //Verificar si ya existe en la base de datos (Caché)
        ...
        //Si no existe, ejecutamos el análisis
    ...
    public StatsResponse getStats() {
        ...
        //Retornamos el objeto DTO con los datos
